...
def wordle(choice, guess, guesses_past):
    ...
    # Assume word is incorrect initially through reseting color
...
# Main funcion, create server-client relationship
def main():
    ...
    with create_new_socket() as s:
        ...
        with conn:
            ...
            message = f'Word: {response}  (the word has a length of {word_length})'
